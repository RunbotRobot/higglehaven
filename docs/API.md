...
After expanding, generating landlets that are fully enclosed by the new circle
become greenbelt and receive `generatedAt` and `claimableAt` timestamps. Polygon
...
The migrations currently create six main backend tables:
