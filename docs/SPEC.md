# higglehaven — Specification Document (v10)
...
**Day-night cycle:** shared, compressed **4-hour cycle** (1 hour each: daylight, dusk, night, dawn) — not real-world-time-per-user. Ensures every time zone sees the full lighting range multiple times per real day.
...
- **Review incentives:** small dáller bonus for genuine, substantive reviews, capped per account/period.
